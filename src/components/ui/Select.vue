<template>
  <div ref="activator">
    <button
      :id
      class="px-3 py-2 bg-primary dark:bg-dark-primary hover:bg-primary-hover dark:hover:bg-dark-primary-hover focus:ring-4 focus:outline-none focus:ring-primary-focus dark:focus:ring-dark-primary-focus font-medium rounded-lg text-sm text-center inline-flex items-center"
      type="button"
